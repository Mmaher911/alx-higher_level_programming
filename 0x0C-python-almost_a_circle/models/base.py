#!/usr/bin/python3
'''
    Creating base class of all other classes IN this project.
'''
import json
import csv
...
class Base:
    '''
        This will manage the id attribute for all classes.
        Arguments:
    ...
    def to_json_string(list_dictionaries):
        '''
            Converting dict into a json string
        '''
    ...
    def save_to_file(cls, list_objs):
        '''
            Write string representation of an object of a class in file
        '''
    ...
    def create(cls, **dictionary):
        '''
            Returns instance with all attributes that already set
        '''
